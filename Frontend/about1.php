...
.slider.round:before {
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="image1.php" class="nav-link"><b>Image Processing</b></a></li>
			            ...
			            <li class="nav-item active"><a href="about1.php" class="nav-link"><b>About</b></a></li>
 ...
 <div class="hero-wrap hero-bread" style="background-image: url('images/about2.jpg');">
   ...
   <section class="ftco-section bg-light">
		...
		<p>Defining quality in food production is, arguably, one of the most widespread and
complicated issues to solve when new products are released in the market. In
short, food quality can be defined as the characteristics of food that are between
certain limits of acceptance in every step of manufacturing, from the raw materials
to the acceptance of consumers. Usage of computer science in terms of grading
raw materials in our country is still not that popular in industrial levels. Our project
aims to create a detector of freshness and defection for grading general raw fruits
or vegetables for industrial use.</p><br>
<p>Fruit freshness grading via computer vision technology exploits on the fruit
texture, colour and shape for visual feature evaluation. The whole system will
work on identifying the raw and stale elements and separate them from the
fresh ones. This project will work using some specific food and vegetables
(Apple, Banana, Mango, Tomato). All system information will be maintained in
a database. The system is designed to use as few people as possible and get
higher production rate and product quality.
    	</p>
    		<!--<div class="row">


    					<a href="#" class="img-prod"><img class="img-fluid" src="images/jetsonFinal.jpg" alt="Colorlib Template" style="width:700px;height:500px;" >
						<p>A conveyer belt will be used to deliver the fruits and
vegetables in a single column which will be headed directly
for the freshness detection process.</p>
    			...
    			<!--<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
    				<div class="product d-flex flex-column">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/jetsonFinal.jpg" alt="Colorlib Template" style="width:300px;height:300px;">
  ...
  <span class="slider round"></span>
    			...
    			<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
    				<div class="product d-flex flex-column">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/95b93a2ac7f0412b67f90f0c8dadf665.jpg" alt="Colorlib Template" style="width:300px;height:300px;">
    						<span class="status"></span>
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3">
    			...
    			<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
    				<div class="product">
    					...
    					<div class="text py-3 pb-4 px-3">
    						...
    						<h3><a href="#">DJ & SOUND SYSTEM</a></h3>
  							<div class="pricing">
	    						<p class="price"><span></span></p>
	    					</div>
	    					<p class="bottom-area d-flex px-3">
