...
.slider.round:before {
  ...
  <body class="goto-here">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="image1.php" class="nav-link"><b>Image Processing</b></a></li>
    ...
    <!-- END nav -->
 <div class="hero-wrap hero-bread" style="background-image: url('images/image.jpg');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<!--<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span> <span>Shop</span></p>-->
            <h1 class="mb-0 bread">Image Processing Zone</h1>
          </div>
        </div>
      </div>
    </div>
...
<!-- -->
<p><h3>Incoming vegetables & fruits through conveyer belt</h3></p>
